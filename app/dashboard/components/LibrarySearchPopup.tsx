...
const LIBRARY_ITEMS: LibraryItem[] = [
  ...
  // 조회·서류
  {
    ...
    icon: "file",
    keywords: [
      "서류", "청구서류", "진단서", "소견서", "입퇴원", "수술확인서", "보험금청구", "청구방법",
      // 생명보험사
      "삼성생명", "한화생명", "교보생명", "신한라이프", "NH농협생명", "흥국생명", "동양생명",
      "ABL생명", "DB생명보험", "AIA생명", "메트라이프생명", "처브라이프생명", "미래에셋생명",
      "라이나생명", "KDB생명", "카디프생명", "하나생명", "푸본현대생명", "교보라이프플래닛", "iM라이프",
      // 손해보험사
      "삼성화재", "현대해상", "KB손보", "DB손보", "메리츠화재", "한화손보", "롯데손보", "MG손보",
      "흥국화재", "NH농협손보", "하나손보", "캐롯손보", "AIG손보", "AXA손보", "처브손보", "더케이손보",
    ],
  },
  {
    id: "underwriting",
    ...
    icon: "shield",
    keywords: [
      "인수", "인수기준", "간편심사", "유병자", "가입가능", "회사별", "심사", "고지",
      "삼성생명", "한화생명", "교보생명", "신한라이프", "NH농협생명", "흥국생명", "동양생명",
      "ABL생명", "DB생명보험", "AIA생명", "메트라이프생명", "미래에셋생명", "라이나생명", "KDB생명",
      "삼성화재", "현대해상", "KB손보", "DB손보", "메리츠화재", "한화손보", "롯데손보", "흥국화재",
    ],
  },
  {
    id: "gongsi",
