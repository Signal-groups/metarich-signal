...
const CATEGORY_METRICS: Record<string, { key: string; label: string; hint: string }[]> = {
  ...
  health: [
    ...
    { key: "injurySurgery", label: "상해 일반 수술비", hint: "상해 일반 수술비 (만원)" },
    { key: "diseaseSurgery", label: "질병 일반 수술비", hint: "질병 일반 수술비 (만원)" },
    { key: "injuryComprehensiveSurgery", label: "상해 종합 수술비", hint: "상해 종합 수술비 (만원)" },
    { key: "diseaseComprehensiveSurgery", label: "질병 종합 수술비", hint: "질병 종합 수술비 (만원)" },
    { key: "injuryAdvancedSurgery", label: "상해 상급 수술비", hint: "상해 상급 수술비 (만원)" },
    { key: "diseaseAdvancedSurgery", label: "질병 상급 수술비", hint: "질병 상급 수술비 (만원)" },
    { key: "injuryTypeSurgery", label: "상해 종수술비", hint: "상해 종수술비 최대 또는 기준 금액 (만원)" },
    { key: "diseaseTypeSurgery", label: "질병 종수술비", hint: "질병 종수술비 최대 또는 기준 금액 (만원)" },
    { key: "diseaseNSurgery", label: "질병 N대 수술비", hint: "질병 N대 수술비 최대금액 (만원). 상해 N대는 추출하지 않음" },
    { key: "chemoDrug", label: "항암 약물치료", hint: "항암 약물치료 보장금액 (만원)" },
    { key: "chemoRadiation", label: "항암 방사선치료", hint: "항암 방사선치료 보장금액 (만원)" },
    { key: "targetDrug", label: "표적항암 약물치료", hint: "표적항암 약물치료 보장금액 (만원)" },
    { key: "targetRadiation", label: "표적항암 방사선치료", hint: "표적항암 방사선치료 보장금액 (만원)" },
    { key: "cancerMajorTreatmentGeneral", label: "암 주요치료비 일반", hint: "암 주요치료비 일반 기준 (만원)" },
    { key: "cancerMajorTreatmentNonCovered", label: "암 주요치료비 비급여", hint: "암 주요치료비 비급여 기준 (만원)" },
    { key: "twoMajorTreatmentComprehensive", label: "2대 주요치료비 종합", hint: "뇌·심장 2대 주요치료비 종합 기준 (만원)" },
    { key: "twoMajorTreatmentAdvanced", label: "2대 주요치료비 상급", hint: "뇌·심장 2대 주요치료비 상급 기준 (만원)" },
