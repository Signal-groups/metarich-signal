...
const CATEGORY_METRICS: Record<string, { key: string; label: string; hint: string }[]> = {
  ...
  care: [
    { key: "caregiverDaily", label: "간병인 사용일당", hint: "일당 금액 (만원)" },
    { key: "integratedDaily", label: "간호간병통합일당", hint: "통합병동 일당 (만원)" },
    { key: "dementia", label: "치매 진단/간병", hint: "치매 보장금액 (만원)" },
    { key: "ltc1to2", label: "장기요양 1~2등급", hint: "1~2등급 지급금액 (만원)" },
    { key: "ltc3to5", label: "장기요양 3~5등급", hint: "3~5등급 지급금액 (만원)" },
    { key: "premiumType", label: "갱신/비갱신", hint: "갱신형 또는 비갱신형" },
  ],
  homecare: [
    { key: "visitCare", label: "방문요양", hint: "방문요양 보완금액 (만원)" },
    { key: "dayNight", label: "주야간보호", hint: "주야간보호 금액 (만원)" },
    { key: "welfareTool", label: "복지용구", hint: "복지용구 금액 (만원)" },
    { key: "familyCare", label: "가족돌봄 지원", hint: "가족돌봄 지원금액 (만원)" },
    { key: "facility", label: "시설 전환 대비", hint: "요양원 전환 시 금액 (만원)" },
    { key: "grade", label: "대상 등급", hint: "장기요양등급 텍스트" },
  ],
  pet: [
