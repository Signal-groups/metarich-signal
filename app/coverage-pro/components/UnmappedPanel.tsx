...
const QUICK_OPTIONS: Array<{ label: string; rowKey: string }> = [
  ...
  { label: '양성뇌종양', rowKey: 'benign_brain_tumor' },
  { label: '뇌혈관 산정특례', rowKey: 'brain_special_case' },
  { label: '심장 산정특례', rowKey: 'heart_special_case' },
  { label: '암 산정특례', rowKey: 'cancer_special_case' },
  ...
  { label: '민사소송법률비용', rowKey: 'driver_civil_litigation' },
  { label: '자동차사고부상(14급)', rowKey: 'driver_injury_14' },
