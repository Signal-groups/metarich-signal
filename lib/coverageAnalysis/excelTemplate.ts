...
const NAME_TO_ROW_KEY: Array<{ patterns: string[]; rowKey: string }> = [
  ...
  // 후유장해 — 80% → 50% → 3%~ 순서
  { patterns: ['질병후유장해80', '질병80%', '질병80%이상', '질병80이상'], rowKey: 'disability_disease_80' },
  { patterns: ['질병후유장해50', '질병50%', '질병50%이상', '질병50이상'], rowKey: 'disability_disease_50' },
  { patterns: ['질병후유장해', '질병 후유'], rowKey: 'disability_disease' },
  { patterns: ['상해후유장해80', '상해80%', '재해80%', '상해80%이상', '상해80이상'], rowKey: 'disability_injury_80' },
  ...
  { patterns: ['교통재해사망', '대중교통재해사망', '재해사망보험금', '재해사망급여금', '상해사망보험금', '상해사망급여금', '재해사망', '상해사망', '사고사망', '재해로인한사망'], rowKey: 'death_injury' },
