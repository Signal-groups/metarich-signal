...
const NAME_TO_ROW_KEY: Array<{ patterns: string[]; rowKey: string }> = [
  ...
  // 시설요양: '시설' 포함 급여금 — 재가 catch-all보다 먼저 (구체적 패턴 우선)
  { patterns: ['시설요양급여금', '시설요양보험금', '시설요양지원금', '시설요양생활비', '시설요양비', '시설요양'], rowKey: 'facility_benefit' },
  { patterns: [
      // 기존
      '재가급여', '재가서비스', '방문요양', '방문간호', '방문목욕', '주야간보호', '단기보호',
      '재가보험금', '재가지원금', '재가비', '재가이용',
      // 추가: '요양급여금' 계열 — '장기요양급여금'·'재가요양급여금' 모두 catch
      '재가요양급여금', '재가요양보험금', '재가요양지원금', '재가요양생활비',
      '요양급여금', '요양보험금', '요양지원금', '요양생활비',
      // 장기요양 급여금 계열 (ltc_grade의 '장기요양' 보다 먼저)
      '장기요양급여금', '장기요양보험금', '장기요양지원금', '장기요양생활비',
    ], rowKey: 'homecare_benefit' },
  { patterns: ['시설급여', '시설입소', '시설서비스', '시설보험금', '시설지원금', '요양시설', '시설이용', '시설비용'], rowKey: 'facility_benefit' },

  // ── 장기요양 등급 (재가/시설 급여보다 뒤에 — 급여명이 먼저 매핑) ──────
  // 주의: '요양급여금'/'장기요양급여금' 등은 위 homecare_benefit에서 먼저 catch됨
  ...
  { patterns: ['간병인사용입원일당(질병)', '질병간병인사용입원일당', '간병인질병', '질병간병인', '질병간병지원금', '질병간병', '병원사용간병', '병원간병', '간병인서비스', '간병급여금', '간병보험금', '간병지원금'], rowKey: 'nursing_hospital' },
